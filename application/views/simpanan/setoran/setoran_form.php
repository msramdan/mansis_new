...
<section class="content">
  ...
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">Add Setoran</h3>
      <div class="pull-right">
        <a href="<?= site_url('simpanan/setoran') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="col-md-4 col-md-offset-4">
          <form action="<?= site_url('simpanan/process') ?>" method="post">
            ...
            <div class="form-group ">
              ...
              <input type="text" name="nama_penyetor" id="nama_penyetor" class="form-control " placeholder="Nama Penyetor">
            </div>
            <div class="form-group ">
              <label for="identitas_kuasa">No Identitas Penyetor</label>
              <input type="text" name="identitas_kuasa" id="identitas_kuasa" class="form-control " placeholder="No Identitas Penyetor">
            </div>
            <div class="form-group ">
              <label for="alamat_penyetor">Alamat Penyetor</label>
              <input type="text" name="alamat_penyetor" id="alamat_penyetor" class="form-control " placeholder="Alamat Penyetor">
            </div>

            <div class="form-group">
              <button type="submit" name="setoran_add" id="setoran_add" class="btn btn-success btn"><i class="fa fa-paper-plane"></i>Save</button>
