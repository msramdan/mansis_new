    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('simpanan/penarikan_add') ?>" class="btn btn-primary btn-flat">
                    <i class="fa fa-plus"></i>Add Penarikan
                </a>
            </div>
        </div>
                    ...
                    foreach ($row as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                ...
                                <a href="<?= site_url('simpanan/penarikan_del/' . $value->simpanan_id) . "/" . $value->jenis_id ?>" onclick="return confirm('Yakin Akan Hapus ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>Delete</a>
                                </form>
                            </td>
                        </tr>
                    <?php
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Penarikan Detail</h4>
            </div>
