       ...
       <!--             <div class="form-group ">
                 ...
                 <?php } ?>
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" name="detail" id="detail" class="form-control " placeholder="Rusak / Hilang / Kadaluwarsa / etc " required="">
                  </div>


                  <div class="form-group">
                    <button type="submit" name="out_add" class="btn btn-success btn"><i class="fa fa-paper-plane"></i>Save</button>
