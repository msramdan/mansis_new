      ...
      <div class="box">
          <div class="box-header">
            ...
            <div class="pull-right">
              <a href="<?=site_url('stockin/add')?>" class="btn btn-primary btn-flat">
                ...
                foreach ($row as $key => $value) {?>
                  <tr>
                    ...
                    <td class="text-center" width="160px">
                      ...
                      <a href="<?=site_url('stockin/del/'.$value->stock_id.'/'.$value->item_id)?>" onclick="return confirm('Yakin Akan Hapus ?')" class ="btn btn-danger btn-xs"><i class="fa fa-trash"></i>Delete</a>                       
                    </form>
                    </td> 
                  </tr>
                  <?php  
