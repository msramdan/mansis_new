  ...
  <div class="box">
    <div class="box-header">
      ...
      <div class="pull-right">
        <a href="<?= site_url('kas/pemasukan') ?>" class="btn btn-warning btn-flat">
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4">
          <form action="<?= site_url('kas/process') ?>" method="post">
            ...
            <div class="form-group">
              <button type="submit" name="pemasukan_add" id="pemasukan_add" class="btn btn-success btn"><i class="fa fa-paper-plane"></i>Save</button>
