<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Laporan Pinjaman Supplier</li>
    </ol>
</section>
...
<section class="content">
    <div class="box">
        <div class="box-header" title="Detail Pinjaman" data-toggle="" data-original-title="Detail Pinjaman">
            <h3 class="box-title"> <strong>Laporan Pinjaman Supplier</strong> </h3>
        ...
        <div class="box-body">
            <form>
                ...
                <div class="d-flex justify-content-between" style="font-size: 17px;">
                    ...
                    <div style="width:20%; display: inline-block; margin: 0px 5px;" class="form-group">
                        <button class="btn btn-primary btn-tampil-laporan" data-link="<?= base_url('laporan/lap_pinjaman_supplier/process/') ?>">Tampilkan Data</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="box">
        <div class="box-header" title="Detail Pinjaman" data-toggle="" data-original-title="Detail Pinjaman">
            <h3 class="box-title"> <strong>Laporan Pinjaman Supplier</strong> <strong><span id="tanggal_awal"></span> <span id="tanggal_akhir"></span></strong> </h3>
            <div class="box-tools pull-right">
                <button class="btn btn-primary btn-xs" data-widget="collapse">
                    <i class="fa fa-minus"></i>
                </button>
            ...
            $.ajax({
                ...
                .done(function(data) {
                    if ((tanggal_awal == '' && tanggal_akhir == '')) {
                        ...
                        $('#cetak_laporan').show();
                        $('#cetak_laporan').attr('href', '<?= base_url('laporan/lap_pinjaman_supplier/cetak/') ?>' + tanggal_awal + '/' + tanggal_akhir);
